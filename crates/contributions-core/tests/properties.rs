...
fn padding_recapture_never_exceeds_the_full_consent_ceiling() {
    ...
    // …but never exceeds the full-consent ceiling beyond integer rounding dust.
    assert!(
...
/// recapture), padding cannot increase the set's combined take beyond integer rounding dust.
/// Hamilton allocates at most one extra unit per recipient; 64 units conservatively bounds
/// those boundary changes plus earlier fixed-point rounding in this small generated corpus.
#[test]
