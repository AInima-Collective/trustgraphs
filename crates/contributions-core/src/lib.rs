...
//! everything.
//!
//! Interface contract: `research/operations/contributions/interfaces.md` (FROZEN). Golden vectors:
//! `tests/golden/contributions.json` (Rust ⟷ Solidity ⟷ guest ⟷ TS four-way parity).
//!
