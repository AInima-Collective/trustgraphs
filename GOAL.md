...
- Current envelope verifier: `packages/envelopes/src/eas_offchain.rs`.
- Current lane-2 reconciliation: `packages/pagerank-core/src/lane2.rs` and
  `packages/pagerank-core/src/reconcile.rs`.
...
- Checkpoint and proof gate: `src/contracts/merkle/MerkleSnapshot.sol`; journal v3 remains the
...
- Enable an opt-in cohort and soak for at least 14 days and at least 20 successfully proven hybrid
  ...
  and one indexer/prover process independently; execute conflict recovery and re-pin drills.
