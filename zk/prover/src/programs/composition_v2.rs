//! Host/prover for the isolated `trust-compose` params/manifest V2 SP1 program.

use anyhow::Result;
use clap::Subcommand;
use composition_core_v2::{codec, compute::compute, fixture, GuestInput};
use sp1_sdk::{include_elf, Elf};

use crate::common;

pub fn elf() -> Elf {
    include_elf!("trustgraph-compose-program-v2")
}
...
const OUT_DIR: &str = "trust-compose-v2";
