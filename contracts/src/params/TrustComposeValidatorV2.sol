...
/// @title TrustComposeValidatorV2
/// @notice Constitutional validation for V2 composition params and the compact `TGCP` V2 source
///         policy. V2 admits one closed compatibility class of program/output-domain pairs — the
...
library TrustComposeValidatorV2 {
    ...
    function validateCreation(TrustComposeParamsCodecV2.Params memory p) internal pure {
        if (
    ...
    function validateFinal(TrustComposeParamsCodecV2.Params memory p, bytes calldata manifest)
        internal
        pure
    ...
    function validateComputationalEnvelope(TrustComposeParamsCodecV2.Params memory p) internal pure {
    ...
    function validateRotation(
        TrustComposeParamsCodecV2.Params memory next,
        TrustComposeParamsCodecV2.Params memory initial
    ) internal pure {
    ...
    function _validateStatic(TrustComposeParamsCodecV2.Params memory p, bool requirePolicy) private pure {
