...
///         (research/operations/contributions/interfaces.md): ContributionResolver → the three schema
...
contract DeployContributionsInstance is Common {
    ...
    /// The three schema strings, EXACTLY as frozen in research/operations/contributions/interfaces.md §1
