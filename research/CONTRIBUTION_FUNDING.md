...
**Status:** design draft, 2026-07-22 — since **Built** as the contributions program (full round proven + paid out on local anvil; see [`docs/concepts/networks-and-programs.md`](../docs/concepts/networks-and-programs.md) and [`research/operations/contributions/`](../research/operations/contributions/)).
