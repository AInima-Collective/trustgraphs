...
**Status:** ⚠️ **Superseded by the ZK root producer** ([`ZK_ARCHITECTURE.md`](./ZK_ARCHITECTURE.md)); kept as design provenance. Originally a design proposal / spec, highly experimental like the rest of TrustGraph.
