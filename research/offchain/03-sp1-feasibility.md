...
> Source research for [`../OFFCHAIN_ATTESTATIONS_ZK.md`](../OFFCHAIN_ATTESTATIONS_ZK.md). Compiled 2026-07-10 · Grounded against this repo (SP1 pinned `=6.3.1` in `zk/program/Cargo.toml` and `zk/prover/Cargo.toml`; current guest ≈ **1.79M cycles** for the sample input, signer guest ≈ **1.85M cycles**, per `docs/trust-graph/RUNBOOK.md`).
