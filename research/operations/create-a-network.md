...
> Internal implementation reference retained from the original public guide.
...
distinction is defined in [`networks-and-programs.md`](../../docs/concepts/networks-and-programs.md)).
...
Program context: [`networks-and-programs.md`](../../docs/concepts/networks-and-programs.md) —
...
start at [`what-is-trustgraphs.md`](../../docs/learn/what-is-trustgraphs.md); for the exact
mechanics of damping, seed share and decay, read
[`algorithm.md`](../../docs/concepts/algorithm.md); for the design work on seed selection,
...
[`networks-and-programs.md`](../../docs/concepts/networks-and-programs.md)); `params.json`
...
forge script contracts/script/DeployGovernedProgramFactories.s.sol:DeployGovernedWeightedTrustgraphsFactory --sig 'run(string)' <weightedFactory> …
forge script contracts/script/DeployGovernedProgramFactories.s.sol:DeployGovernedTrustComposeFactory --sig 'run(string)' <trustComposeFactory> …
...
- [`integrate-scores.md`](../../docs/build/integrate-scores.md) — reading your network's proven scores from an
