...
> Internal interface reference. This page is not part of the public product documentation.

**Status: FROZEN.** This file is the interface contract for the `contributions`
program (see [`networks-and-programs.md`](../../../docs/concepts/networks-and-programs.md) for the program index).
...
(normative); program index: [`networks-and-programs.md`](../../../docs/concepts/networks-and-programs.md), deviations of record: [`research/DEVIATIONS.md`](../../../research/DEVIATIONS.md).
