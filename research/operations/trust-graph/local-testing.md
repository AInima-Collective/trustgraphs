...
instance) has its own guide: [`research/operations/hypercerts/local-testing.md`](../hypercerts/local-testing.md).
...
[`../setup.md`](../../../docs/build/setup.md) installs each. Then `task setup` and `task zk:build`; the guest ELFs
...
4. **Hypercerts instance** — the fourth program end-to-end (see the
   [hypercerts guide](../hypercerts/local-testing.md)).
...
in [`../signer-sync/runbook.md`](../signer-sync/runbook.md).
...
> [`../create-a-network.md`](../create-a-network.md) §5. The manual sequence below is still the right thing for a single
...
See [`README.md`](../../../README.md), [`networks-and-programs.md`](../../../docs/concepts/networks-and-programs.md) (the program index),
[`runbook.md`](./runbook.md), and
[`research/ZK_ARCHITECTURE.md`](../../../research/ZK_ARCHITECTURE.md) for the design and the full
command reference. Hypercerts local testing: [`research/operations/hypercerts/local-testing.md`](../hypercerts/local-testing.md).
