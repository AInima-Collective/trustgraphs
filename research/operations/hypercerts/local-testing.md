...
[`research/operations/trust-graph/local-testing.md`](../trust-graph/local-testing.md); operations for a real deployment are in
[`runbook.md`](./runbook.md); third-party epoch reproduction is [`reproduce-an-epoch.md`](../../../docs/verify/reproduce-an-epoch.md).
...
`task setup` and `task zk:build` ([`../setup.md`](../../../docs/build/setup.md)). The quick check needs nothing
...
reuse a stale ELF: `task zk:build` (see [`../setup.md`](../../../docs/build/setup.md#build-the-zk-guest-programs)).
...
[`networks-and-programs.md`](../../../docs/concepts/networks-and-programs.md) for the program index and vkey/toolchain caveat.
