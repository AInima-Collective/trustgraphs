...
for the design, [`networks-and-programs.md`](../../../docs/concepts/networks-and-programs.md) for the program index and the vkey, and the
...
> documented in [`reproduce-an-epoch.md`](../../../docs/verify/reproduce-an-epoch.md).
...
1. Re-derive all affected vkeys on the **pinned toolchain**; diff against [`networks-and-programs.md`](../../../docs/concepts/networks-and-programs.md).
