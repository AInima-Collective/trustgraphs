...
/// @notice Harness for `test/e2e/governed-creation.sh` (indexer M0 regression): creates one
...
///         bound; only the SNARK check is stubbed — the same seam `test/e2e/run.sh` uses, see
