...
for (const directory of [
  ...
  join(process.cwd(), '../packages/pagerank-core/src'),
  join(process.cwd(), '../packages/hypercerts-core/src'),
  join(process.cwd(), '../packages/contributions-core/src'),
  join(process.cwd(), '../packages/weighted-prior-core/src'),
