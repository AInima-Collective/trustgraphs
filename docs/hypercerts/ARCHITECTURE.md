...
at `=1.1.0`** (bumping it is a deliberate event with a vkey-rotation plan, per GOAL.md ground rule 6).
...
> **Runbook comes at M4/M5.** The build is the GOAL.md sequence M1→M5 (spike → lane-2 infra → atproto
