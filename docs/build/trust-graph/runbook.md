...
on the exact toolchain build — read the reproducibility caveat in [`networks-and-programs.md`](../../concepts/networks-and-programs.md)
...
> **vkey:** the current trust-graph vkey is recorded in [`networks-and-programs.md`](../../concepts/networks-and-programs.md) (it
