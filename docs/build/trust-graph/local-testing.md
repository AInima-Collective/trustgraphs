...
instance) has its own guide: [`docs/build/hypercerts/local-testing.md`](../hypercerts/local-testing.md).
...
See [`README.md`](../../../README.md), [`networks-and-programs.md`](../../concepts/networks-and-programs.md) (the program index),
[`runbook.md`](./runbook.md), and
[`research/ZK_ARCHITECTURE.md`](../../../research/ZK_ARCHITECTURE.md) for the design and the full
command reference. Hypercerts local testing: [`docs/build/hypercerts/local-testing.md`](../hypercerts/local-testing.md).
