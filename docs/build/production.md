...
manifest is bound to the chain its profile names. The current release image, `v0.1.5`, built from
commit `40e945d` by
[release run 34897235238](https://github.com/AInima-Collective/trustgraphs/actions/runs/34897235238)
