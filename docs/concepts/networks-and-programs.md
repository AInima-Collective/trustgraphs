...
So a community's network is an *instance* of the trust-graph *program* (plus any companion
...
| **trust-graph-weighted** (weighted-prior root producer) | **Core + contracts built; operator pending** | `0x00f0f5e01928bfa9f530392ff7b9cab1efae6ec513eb156cb44d15f5a37b0ed2` (journal v3; detached SP1 6.3.1 guest) | [contract architecture](../build/weighted-prior/architecture.md) · [rotation/recovery runbook](../build/weighted-prior/runbook.md) | no production deployment; operator/indexer integration is tracked by issue #54 |
