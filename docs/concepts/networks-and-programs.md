...
| **trust-compose** (captured final-distribution composer) | **Core/guest built** | `0x002781fb8a17a5586cec2eb47f891d9d292b25f9547e8f0a0309b67efb82d641` (journal v3; detached SP1 6.3.1 guest) | [implementation and measurements](../../research/composition/README.md) · [accepted design](../../research/TRUSTGRAPHS_COMPOSITION.md)                                                                                | no deployment yet; atomic capture and factory wiring are tracked separately                             |
