...
| **contributions** (rep-weighted funding split) | **Building — GOAL.md M2** | `0x0065cd065fabfe54a357afb4a22f2c44a5b88519421292bfc41e9c5c2fec1d90` (M2, SP1 6.3.1 — box-derived; see the reproducibility caveat below) | [interfaces](./contributions/INTERFACES.md) | local anvil dev (GOAL.md M5) |
