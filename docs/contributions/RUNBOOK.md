...
[`LOCAL_TESTING.md`](./LOCAL_TESTING.md). Interfaces (frozen):
...
INTERFACES.md §3). During the window, people attest **claims** (their own
...
The 6-persona worked example in [`LOCAL_TESTING.md`](./LOCAL_TESTING.md) §§4–6
