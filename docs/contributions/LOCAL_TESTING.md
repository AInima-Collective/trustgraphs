...
([`../trust-graph/LOCAL_TESTING.md`](../trust-graph/LOCAL_TESTING.md)) and this one mirrors
its shape.
...
- **Trigger reverts `NotSnapshot`?** The mirror's one-shot `bindSnapshot` is missing — only
  ...
  admit a contributions-blind proof — see [`audits/2026-07-M6.md`](./audits/2026-07-M6.md) M6-1).
