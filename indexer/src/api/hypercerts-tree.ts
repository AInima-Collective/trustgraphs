 ...
 *   - `frontend/lib/pagerank/merkle.ts` — `hashPair` / `buildTree` / `proofFor` / `outputLeaf`
 ...
 *   - `frontend/lib/hypercerts/recompute.ts` — `nodeOutputLeaf` (the unified nodeId leaf) mirroring
