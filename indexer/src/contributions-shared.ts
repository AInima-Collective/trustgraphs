 ...
 * frontend recomputes with (`frontend/lib/contributions` — the fourth parity leg, golden-locked
 * against `test/golden/contributions.json`). The indexer never re-implements scoring; it feeds
