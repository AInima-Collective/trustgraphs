...
/**
 * The module's row-relevant view surface. Deliberately a local `parseAbi` (the `indexer/abis/`
 * convention) rather than an import of `frontend/lib/contract-abis`: that module is CommonJS
