 ...
 * `node_output_leaf`, and the journal-v2 digest — recomputed from `tests/golden/hypercerts.json`
...
const g = JSON.parse(readFileSync('../../tests/golden/hypercerts.json', 'utf8'))
const p = g.params
