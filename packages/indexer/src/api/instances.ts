 ...
 *
 * The response is shaped for a TS client (packages/frontend/lib/types.ts `Network`) and needs no post-
 ...
 * canonical fixed-point → display conversion lives in packages/frontend/lib/pagerank; doing it here would
 * fork it.
 *
