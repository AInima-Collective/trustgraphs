...
// Source of truth: contracts/src/registry/AnchorRegistry.sol. Kept in the indexer (not in
// packages/frontend/lib/contract-abis.ts) because AnchorRegistry is not yet wired into the frontend wagmi
// pipeline (packages/frontend/scripts/generate-config.ts CONTRACT_CONFIG). When the frontend adopts lane-2,
