...
// Source of truth: contracts/src/factory/TrustgraphsFactory.sol. Kept in the indexer (not in
// packages/frontend/lib/contract-abis.ts) so the indexer can keep a narrow event-oriented surface without
